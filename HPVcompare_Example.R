...
source('Rcode/HPVcompare_functions.R')
source('Rcode/HPVcompare_RiskReduction_functions.R')

#Simulation of parameters
nr.sim <- 1000
vacc.up <- c(0.5,0.5)
source('Rcode/HPVcompare_ParametersData.R')

#Base-case scenario (Including herd-immunity, and both AW and RRP)
scenario <- c(2,1,3)
source('Rcode/HPVcompare_RiskReductions.R')
source('Rcode/HPVcompare_Computation.R')
